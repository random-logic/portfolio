  ...
  return <form className="flex flex-col h-full">
    <div className="flex gap-6 pb-6">
      <div className="flex-1">
        ...
        <input required className="text w-full" type="text" placeholder="Name"/>
      </div>
      <div className="flex-1">
        <p className="font-bold pb-2">Your Email</p>
        <input required className="text w-full" type="text" placeholder="Email"/>
      </div>
    </div>
    <p className="font-bold pb-2">Your Message</p>
    <textarea required className="w-full flex-grow h-full mb-6 md:min-h-0 min-h-[200px]" placeholder="Message"/>
